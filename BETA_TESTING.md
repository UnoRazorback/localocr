# LocalOCR Studio Beta 1 Tester Guide

This is a private-repository prerelease for invited testers. You need repository access to download the release and file feedback.
